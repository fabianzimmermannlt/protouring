...
export function Communication({
  ...
  return (
    <div className={`pt-chat-wrapper flex flex-col ${maxHeight} ${className}`}>
      {showHeader && (
      ...
      {/* Nachrichten */}
      <div className="pt-chat-messages flex-1 overflow-y-auto p-4 space-y-3">
        {error && (
      ...
      {/* Input */}
      {enableInput && (
        <div className="pt-chat-input border-t p-3">
