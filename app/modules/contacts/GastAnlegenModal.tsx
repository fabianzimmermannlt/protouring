    ...
    <div className="modal-overlay">
      <div ref={containerRef} className="modal-container" style={{ maxWidth: 760 }}>
        ...
        <div className="modal-body space-y-4">
          ...
          {/* ── ADRESSE & PROFIL ── */}
          <SectionHeading>Adresse &amp; Profil</SectionHeading>
          <div className="grid grid-cols-3 gap-3">
            <div>
          ...
          {/* ── REISE & HOTEL ── */}
          <SectionHeading>Reise &amp; Hotel</SectionHeading>
          <div>
          ...
          {/* ── HONORAR & BANK ── */}
          <SectionHeading>Honorar &amp; Bank</SectionHeading>
          <div className="grid grid-cols-2 gap-3">
            <div>
        ...
        <div className="modal-footer">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={handleSave} disabled={saving} className="btn btn-primary disabled:opacity-50">
              {saving ? <><Loader2 size={13} className="animate-spin" /> Speichern…</> : isEdit ? 'Speichern' : 'Anlegen'}
            </button>
          </div>
        </div>
      </div>
