...
export default function HotelsPage() {
  ...
  const exportToCSV = () => {
    ...
    const headers = [
      ...
      'E-Mail', 'Telefon', 'Website', 'Rezeption', 'Check-in', 'Check-out',
      'Early Check-in', 'Late Check-out', 'Frühstück', 'Frühstück WE', 'Zusätzliche Informationen'
    ]
      ...
      try {
        ...
        const importedHotels: Hotel[] = dataLines.map((line, index) => {
          ...
          return {
            ...
            checkIn: values[10] || '',
            checkOut: values[11] || '',
            earlyCheckIn: values[12] || '',
            lateCheckOut: values[13] || '',
            breakfast: values[14] || '',
            breakfastWeekend: values[15] || '',
            additionalInfo: values[16] || ''
          }
        })
